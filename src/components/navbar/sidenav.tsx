...
const Sidenav = ({
  ...
  return (
    <>
      ...
      <aside className="w-60 overflow-auto max-h-screen sticky top-0 py-3 inset-y-0 left-0 flex-col border-2 bg-background hidden shadow-lg rounded-lg m-3 lg:flex">
